...
プロジェクト概要 / 技術スタック・アーキテクチャ / リポジトリ構成 / ローカル開発環境のセットアップ / ビルド・テスト・デプロイ / 実行環境・インフラ / 外部サービス・連携 / シークレットの管理場所 / 定期作業・運用 / 既知の課題・技術的負債 / トラブル対応ランブック / 進行中の作業・TODO / 関係者・連絡先 / 関連ドキュメント
